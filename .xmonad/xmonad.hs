...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- Restart xmonad
    , ((modm              , xK_q     ), spawn "pulseaudio --kill ; killall conky nm-applet dzen2 syndaemon xcompmgr xscreensaver redshift ; xmonad --recompile; xmonad --restart")
...
myManageHook = (composeAll . concat $
    ...
    , [className    =? c            --> doShift  "3"         |   c   <- myWebs      ] -- move webs to web
...
--
myBitmapsDir = "/home/alios/.xmonad/dzen2"
myXmonadBar = "dzen2 -w 600 -h 16 -ta 'l' -fg '#555753' -bg '#000000' -fn 'Terminus-8'"
...
-- conky
myStatusBar = "conky -c /home/alios/.xmonad/.conky_dzen_clock | dzen2 -x 600 -w 718 -h 16 -ta 'r' -fg '#555753' -bg '#000000' -fn 'Terminus-8'"
...
myStartupHook = do
  ...
  spawn "nm-applet"
  spawn "syndaemon -t -k -i 2"
  spawn "xcompmgr"
  spawn "sleep 3 ; stalonetray"
  spawn "xscreensaver -no-splash"
  spawn "redshift -l 51.962944:7.628694"
  return ()
